...
[Run]
; One-time migration for v1.0 only: reset user data before recreating defaults.
Filename: "{cmd}"; Parameters: "/C if /I ""{#AppVersion}""==""1.0"" if exist ""%APPDATA%\SwiftFind"" rmdir /S /Q ""%APPDATA%\SwiftFind"""; Flags: runhidden
Filename: "{cmd}"; Parameters: "/C if /I ""{#AppVersion}""==""1.0.0"" if exist ""%APPDATA%\SwiftFind"" rmdir /S /Q ""%APPDATA%\SwiftFind"""; Flags: runhidden
